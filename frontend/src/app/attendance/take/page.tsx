...
export default function TakeAttendancePage() {
  ...
  const handleQRCodeScanned = async (qrData: string) => {
    ...
    try {
      ...
      showMessage('error', error.response?.data?.detail || 'Failed to mark attendance')
    }
  }
        ...
        {!selectedCourse && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Choose the course for which you want to take attendance</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Date: {new Date(attendanceDate).toLocaleDateString('en-US', { 
                    weekday: 'long', 
                    year: 'numeric', 
                    month: 'long', 
                    day: 'numeric' 
